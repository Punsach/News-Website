        ...
        <body>
            <div class = "box">
                ...
                <ul>
                    ...
                    $stmt->close();
                    //Form to allow the user to edit the story, which will get passed to mySQL
                    ?>
                    <form method="POST">
                        <p>
                    ...
                    if (isset($_POST['submitStory'])){
                       if(!hash_equals($_SESSION['token'], $_POST['token'])){
                        ...
                        //sanitizing new story, otherwise gives errors if there're apostrophes and such
                    $newBody = $mysqli->real_escape_string($_POST['story']);

                        //update story to edited
