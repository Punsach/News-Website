        ...
        <div class = "box">
            ...
            <ul>
                ...
                if($_SESSION['guest'] == false)
                {
                    ...
                    <?php //This form allows the user to enter in their story, link, and title 
                    } ?>
                </ul>
                <form method="POST">
                    <p>
                ...
                if (isset($_POST['submitStory'])){
                    ...
                    //filters the data and makes sure it cannot be harmful 
                    require "database.php";
                    $link = $_POST['link'];
                    $title = $mysqli->real_escape_string($_POST['title']);
                    $body = $mysqli->real_escape_string($_POST['body']);
                    $username = $_SESSION['user_id'];
                    //Allows users to create stories that will automatically be updated on the page. It queries the corresponding table. 
